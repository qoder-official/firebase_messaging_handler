        ...
        children: [
          ...
          Padding(
            ...
            child: ElevatedButton(
              ...
              onPressed: () async {
                final initialData =
                    await _messagingHandler.getInitialNotificationData();
                if (initialData != null) {
                  setState(() {
                    _currentPayload =
                        'Initial Notification: ${initialData.payload}';
                  });
                } else {
                  setState(() {
                    _currentPayload = 'No initial notification found';
                  });
                }
              },
            ),
    ...
    if (clickStream != null) {
      clickStream.listen((NotificationData? data) {
        if (data != null) {
          ...
          // Example of using iOS badge management
          if (data.badgeCount != null && data.badgeCount! > 0) {
            _messagingHandler.setIOSBadgeCount(data.badgeCount!);
          }
        }
      });
    }
